...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the InfoBudget mock pipeline.")
    parser.add_argument(
        "--scoring-mode",
...
def main() -> None:
    ...
    pipeline = InfoBudgetPipeline.from_config_dir("configs", scoring_mode=args.scoring_mode)
